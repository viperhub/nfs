    ...
    <nav class="bg-white border-gray-200 px-4 lg:px-6 py-2.5">
      <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
        <router-link to="/" class="flex items-center">
          <img src="/images/logo.png" class="mr-3 h-12 sm:h-20" alt="App Logo" />
        </router-link>
        <div class="flex items-center lg:order-2">
          <router-link
            to="call:1900 636 736"
        ...
        >
          <ul class="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
            <li>
              <router-link
                to="/"
                :class="{ 'text-orange-700': route.path === '/' }"
            ...
            <li>
              <router-link
                to="/news"
                :class="{ 'text-orange-700': route.path.startsWith('/news') }"
                class="block py-2 pr-4 pl-3 text-gray-700 border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-orange-700 lg:p-0"
              >
                Tin tức
              </router-link>
